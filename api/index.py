# /api/index.py (Versão com Sistema de Login/Register Completo)
...
app.config['SECRET_KEY'] = os.getenv("SECRET_KEY", "catolia-secret-vercel")
        ...
        def generate_response():
            ...
            try:
                ...
                if cf_flag and full_ai_response:
                    ...
                    yield f"data: {json.dumps({'content': convite, 'show_cf_card': True})}\n\n"
